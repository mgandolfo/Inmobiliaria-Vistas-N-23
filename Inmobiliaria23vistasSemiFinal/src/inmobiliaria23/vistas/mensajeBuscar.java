 ...
 * @author mgandolfo
 */
public class mensajeBuscar extends javax.swing.JDialog {
    
    int  xMouse, yMouse;

    public mensajeBuscar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextField1.setFont(new java.awt.Font("Roboto Cn", 1, 14)); // NOI18N
        ...
        jLabel2.setText("Ingrese el n° DNI para buscar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensajeBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                mensajeBuscar dialog = new mensajeBuscar(new javax.swing.JFrame(), true);
